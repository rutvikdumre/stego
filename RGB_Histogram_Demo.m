...
imagesFolder = fileparts(which('flower.jpg')); % Determine where demo folder is (works with all versions).
...
imageFiles = [jpegFiles; tifFiles; pngFiles; bmpFiles;jpgFiles];
